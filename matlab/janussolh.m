function z=janussolh(PREC,y)
% z=janussolh(PREC,y)
%
% solve system with given block ILU , (SL^{-1} Q LDU P^T SR^{-1})^H z = y
%
% Input
% -----
...
%
%	http://bilu.tu-bs.de/
% $Id: janussolh.m 4135 2018-04-18 15:34:46Z bolle $
...
if PREC.isreal
   ...
   if PREC.issymmetric
      z=conj(PREC.SL*(PREC.P*bildlsols(PREC.BL,PREC.BiD,pivots,PREC.P'*(PREC.SL*conj(y)))));
   ...
   % general non-real case
      ...
      z=PREC.SR*(PREC.P*bilusolh(PREC.BL,PREC.BiD,PREC.BUT,pivots,PREC.Q'*(PREC.SL*y)));
      % z=bilusol(PREC.BL,PREC.BiD,PREC.BUT,y);
   end
end
