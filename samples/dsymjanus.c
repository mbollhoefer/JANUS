...
{
    // prescribe lower triangular part of a sparse symmetric matrix
    ...
    double        val0[4]   ={-17.0,1.0,2.0,5.0},
                  val1[3]   ={8.0,4.0,2.0},
		  val2[2]   ={7.0,1.0},
		  val3[2]   ={3.0,1.0},
		  val4[3]   ={6.0,1.0,5.0},
    ...
    //-------------------------------------------------------------------------
    //-------------- set up user default options for block ILDL ---------------
    //-------------------------------------------------------------------------
...
/*
	...
	$Id: dsymjanus.c 6263 2020-05-15 07:04:30Z bolle $
*/
