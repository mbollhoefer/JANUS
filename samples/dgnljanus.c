...
{
    // prescribe nonsingular sparse matrix
    ...
    double        val0[1]   ={7.0},
                  val1[3]   ={-4.0,-4.0,1.0},
		  val2[5]   ={1.0,8.0,1.0,7.0,-3.0},
		  val3[1]   ={7.0},
		  val4[1]   ={2.0},
		  val5[2]   ={2.0,3.0},
		  val6[4]   ={7.0,9.0,11.0,2.0},
		  val7[3]   ={5.0,8.0,5.0},
    ...
    if (ierr) {
       printf("computation of block incomplete ILU failed\n");
       JanusDelete(&PREC);
       return (-1);
    }
...
/*
	...
	$Id: dgnljanus.c 6263 2020-05-15 07:04:30Z bolle $
*/
